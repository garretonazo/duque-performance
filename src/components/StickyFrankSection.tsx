...
// Componentes eliminados - usando contenido directo
...
export default function StickyFrankSection() {
  ...
  return (
    ...
    >
      ...
      >
        <section className="min-h-screen w-full flex flex-col lg:flex-row items-center justify-center gap-4 md:gap-6 lg:gap-8 py-8 md:py-12 lg:py-[.4rem] px-4 md:px-6 lg:px-[.4rem] bg-duque-gray">
          {/* Layout Mobile/Tablet: Vertical */}
          <div className="flex flex-col items-center justify-center w-full lg:hidden">
            {/* Título arriba */}
            <h2 className="font-barlow mb-4 md:mb-6 leading-tight text-center text-3xl md:text-4xl lg:text-5xl text-duque-yellow">Entrena con DUQUE</h2>
            
            {/* Imagen centrada */}
            <div className="flex-shrink-0 flex justify-center mb-4 md:mb-6">
              <img
                src="/images/duque1.0.9.png"
                alt="Frank Duque"
            ...
            {/* Texto abajo */}
            <p className="font-neue-montreal uppercase text-base md:text-lg lg:text-[18px] leading-relaxed text-center max-w-lg text-white">
              En DUQUE PERFORMANCE sabemos que cada deportista es único y por ende el rendimiento de sus capacidades físicas es variable, debido a esto los programas de entrenamiento están diseñados específicamente en potenciar las fortalezas y superar las debilidades de cada atleta.
            </p>
          </div>
          ...
          <div className="hidden lg:flex w-full items-center justify-center gap-8">
            ...
            <div className="flex-1 max-w-xl flex flex-col items-center justify-center">
              <h2 className="font-barlow mb-4 leading-tight text-center text-5xl text-duque-yellow">Entrena con DUQUE</h2>
              <p className="font-neue-montreal uppercase text-[18px] leading-relaxed text-center text-white">
                En DUQUE PERFORMANCE sabemos que cada deportista es único y por ende el rendimiento de sus capacidades físicas es variable, debido a esto los programas de entrenamiento están diseñados específicamente en potenciar las fortalezas y superar las debilidades de cada atleta.
              </p>
            </div>
          </div>
      ...
      >
        <section className="min-h-screen w-full flex flex-col lg:flex-row items-center justify-center gap-4 md:gap-6 lg:gap-8 py-8 md:py-12 lg:py-[.4rem] px-4 md:px-6 lg:px-[.4rem] bg-duque-gray">
          ...
          <div className="flex flex-col items-center justify-center w-full lg:hidden">
            {/* Título arriba */}
            <h2 className="font-barlow mb-4 md:mb-6 leading-tight text-center text-3xl md:text-4xl lg:text-5xl text-duque-yellow">COMPROMISO</h2>
            
            {/* Imagen centrada */}
            <div className="flex-shrink-0 flex justify-center mb-4 md:mb-6">
              <img
                src="/images/duque1.0.7.png"
                alt="Frank Duque"
                className="w-[200px] h-[233px] md:w-[280px] md:h-[327px] object-contain"
                style={{
                  maxWidth: '100%',
            ...
            {/* Texto abajo */}
            <p className="font-neue-montreal uppercase text-base md:text-lg lg:text-[18px] leading-relaxed text-center max-w-lg text-white">
              Cuando te unes a DUQUE PERFORMANCE no solo obtienes un programa de entrenamiento excepcional, si no que también te unes a un compromiso con nuestro equipo de trabajo el cual estará para ayudarte en todo momento de tu proceso.
            </p>
          </div>
          ...
          <div className="hidden lg:flex w-full items-center justify-center gap-8">
            ...
            {/* Texto a la derecha */}
            <div className="flex-1 max-w-xl flex flex-col items-center justify-center">
              <h2 className="font-barlow mb-4 leading-tight text-center text-5xl text-duque-yellow">COMPROMISO</h2>
              <p className="font-neue-montreal uppercase text-[18px] leading-relaxed text-center text-white">
                Cuando te unes a DUQUE PERFORMANCE no solo obtienes un programa de entrenamiento excepcional, si no que también te unes a un compromiso con nuestro equipo de trabajo el cual estará para ayudarte en todo momento de tu proceso.
              </p>
            </div>
